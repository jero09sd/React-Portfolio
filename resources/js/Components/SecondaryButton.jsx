export default function SecondaryButton({
    ...
    return (
        <button
            ...
            type={type}
            className={
                `relative rounded-md m-4 text-white text-center p-2 px-4 bg-gray-800 transition-all duration-500
                ...
                after:border after:border-gray-300 after:scale-125 after:hover:opacity-100 after:hover:scale-100 ${
                    disabled && "opacity-25"
                } ` + className
            }
            disabled={disabled}
